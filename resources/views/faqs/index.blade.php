                ...
                <div class="col-sm-10 col-sm-offset-1">
                    <ul class="accordion accordion-2">
                        <li>
                            ...
                            <div class="content">
                                <p>
                                    It is the annual meeting that brings together Central Bank Governors and Ministers of
                        ...
                        <li>
                            <div class="title">
                                <h4 class="inline-block mb0 custom-faq-title">When will IMF-WB Annual Meetings 2018 take place?</h4>
                            </div>
                            <div class="content">
                                <p>
                        ...
                        <li>
                            <div class="title">
                                <h4 class="inline-block mb0 custom-faq-title">How many meetings that will be held during IMF-WB Annual Meetings 2018?</h4>
                            </div>
                            <div class="content">
                                <p>
                        ...
                        <li>
                            <div class="title">
                                <h4 class="inline-block mb0 custom-faq-title">How many participants of IMF-WB Annual Meetings 2018?</h4>
                            </div>
                            <div class="content">
                                <p>
                        ...
                        <li>
                            <div class="title">
                                <h4 class="inline-block mb0 custom-faq-title">How did Indonesia end up hosting IMF-WB Annual Meetings 2018?</h4>
                            </div>
                            <div class="content">
                                <p>
                                    ...
                                    stage, Indonesia was shortlisted along with several other countries. Finally, Indonesia
                        ...
                        <li>
                            <div class="title">
                                <h4 class="inline-block mb0 custom-faq-title">What are the benefits for Indonesia as a host country of IMF-WB Annual Meetings 2018?</h4>
                            </div>
                            <div class="content">
                                <p class="mb0">
                                ...
                                <p>
                                    ...
                                    2018, they are: i) knowledge-transfer, lessons on hosting international event, ii) trade
                                    and investment, the exposure of local products and investment opportunities as well
                                    as trade transaction, iii) the increasing number of tourists to top 10 main destinations
                                    in Indonesia, iv) Indonesia’s leadership in hosting international event and discussing
                                    global issues.
                                </p>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="content">
                                <p>
                                    ...
                                    2018. It is designed to showcase Indonesia as a reformed, resilient, progressive, and
                        ...
                        <li>
                            <div class="title">
                                <h4 class="inline-block mb0 custom-faq-title">What are the events of Voyage to Indonesia?</h4>
                            </div>
                            <div class="content">
                                <p>
