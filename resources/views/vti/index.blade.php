...
<section class="bg-secondary page-title page-title-4">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center">
                <h4 class="uppercase mb100">IMF</h4>
                <center><hr class = "under_title"></center><br><br>
                Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas porttitor congue massa. Fusce posuere, magna sed pulvinar ultricies, purus lectus malesuada libero, sit amet commodo magna eros quis urna.
            </div>
        </div>
        <!--end of row-->
...
<section class="bg-secondary">
    <div class="container">
        <div class="row v-align-children">
            <div class="col-md-6">
                <img class="cast-shadow" alt="Screenshot" src="{{ asset('img/screenshot.jpg') }}">
            </div>
            <div class="col-md-6">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h3 class="panel-title uppercase">International Monetary Fund</h3>
                  </div>
...
<section class="bg-secondary page-title page-title-4 section_blue">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center">
                <h4 class="uppercase mb100 white">World Bank</h4>
                <center><hr class = "under_title"></center><br><br>
                Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas porttitor congue massa. Fusce posuere, magna sed pulvinar ultricies, purus lectus malesuada libero, sit amet commodo magna eros quis urna.
                Nunc viverra imperdiet enim. Fusce est. Vivamus a tellus.
            </div>
...
<section class="bg-secondary section_blue">
    <div class="container">
        <div class="row v-align-children">
            ...
            <div class="col-md-6">
                <div class="panel panel-default section_blue">
                  <div class="panel-heading section_blue">
                    <h3 class="panel-title uppercase section_blue">World Bank Group</h3>
                  </div>
                  <div class="panel-body">
                    <p>
                    Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas porttitor congue massa. Fusce posuere, magna sed pulvinar ultricies, purus lectus malesuada libero, sit amet commodo magna eros quis urna.
...
<section class="bg-secondary page-title page-title-4 section_blue_light">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center">
                <h4 class="uppercase mb100">Indonesia and IMF World Bank</h4>
                <center><hr class = "under_title"></center>
            </div>
        </div>
        <!--end of row-->
