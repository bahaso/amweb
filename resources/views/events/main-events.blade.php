                ...
                <ul class="accordion accordion-2 one-open">
                    <li class="active">
                        ...
                        <div class="content">
                            ...
                            <p>
                                This restricted meeting will be attended by Minister of Finance or Central Bank Governor
                                representing the elected and invited country to discuss various policy responses related
                                to global economic commitment in achieving growth that is robust, sustainable,
                                inclusive, and balance. Relating to these issues, this meeting in general means to
                                examine all current policy instruments, i.e. structural, fiscal, and monetary
                                reformation – individually and collectively. These policies are implemented to amplify
                                market trust, financial sector stability, and to give opportunities to all countries to
                                be exposed to benefits from globalization and technology.
                            </p>
                        </div>
                    </li>
                    {{--  <li>
