...
$(document).ready(function() { 
    ...
    if (!$('nav').hasClass('fixed') && !$('nav').hasClass('absolute')) {
        ...
        if ($(window).width() > 768) {
            var $fullscreen = $('section.fullscreen:nth-of-type(1)'),
                diff_height = $fullscreen.data( "h-diff" );

            if( typeof diff_height == "undefined" )
            {
                diff_height = 0;
            }

            $fullscreen.css('height', ($(window).height() - $('nav').outerHeight(true) - diff_height));
        }
    ...
    if ($('.countdown').length) {
        $('.countdown').each(function() {
            ...
            $(this).countdown(date, function(event) {
                ...
                var $parent = $(this).parents( ".countdown-timer" ),

                    $days  = $parent.find( ".days .text" ),
                    $hours = $parent.find( ".hours .text" ),
                    $mins  = $parent.find( ".mins .text" ),
                    $secs  = $parent.find( ".secs .text" );
